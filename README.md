...
This project develops an AI controller for a 2D asteroid game designed for the 2026 XFC (eXplainable Fuzzy Control) competition. The goal is to build a high-performance agent that also remains interpretable through fuzzy logic systems.
...
Hybrid neuro-fuzzy experimentation for explainability in control policies
...
4. Hybrid Experiments (Actor-Critic + Fuzzy)
